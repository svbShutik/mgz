...
class BrandController extends Controller
{
    ...
    public function actionUpload()
    {
        ...
        $folder = dirname(Yii::app()->request->scriptFile).DIRECTORY_SEPARATOR.'uploads'.DIRECTORY_SEPARATOR.'brand_img'.DIRECTORY_SEPARATOR ;
        //$folder=Yii::app()->basePath.DIRECTORY_SEPARATOR.'uploads'.DIRECTORY_SEPARATOR.'brand_img'.DIRECTORY_SEPARATOR;
