...
class NestedSetBehavior extends CActiveRecordBehavior
{
	...
	/**
     * Получает предыдущий родственный узел
	...
	/**
     * Получает следующий родственный узел
	...
	/**
     * Добавляет новый узел потомок в первую позицию
	...
	/**
     * Добавляет новый узел потомок в первую позицию $new_node->prepend($root) ;
	...
	/**
     * Добавляет новый узел потомок в последнюю позицию
	...
	/**
     * Перемещает потомка на верхнюю позицию
	...
	/**
     * Перемещает потомка на позицию ниже
	...
	/**
     * Перемещает потомка в первую позицию
	...
	/**
     * Перемещает потомка на последнюю позицию
	...
	/**
     * Перемещает потомка в корневой каталог, и делает его корневым
